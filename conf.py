...
BLOG_AUTHOR = "Rufus Fraanje"  # (translatable)
BLOG_TITLE = "Personal site of Rufus Fraanje"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://prfraanje.github.io/"
...
THEME = "custom_theme" # created with: nikola subtheme -s cerulean -p bootstrap4
...
#LOGO_URL = 'images/rufus-fraanje-small.png'
...
# is in the manual.
COMMENT_SYSTEM_ID = "personal-site-of-rufus-fraanje"
...
# KaTeX a1uto-render settings. If you want support for the $.$ syntax (which may
